  ...
  create  table
    "airup_eu_dwh"."dbt_feldm"."fct_shopify_cohort_processing_new__dbt_tmp"
...
from 
    ...
    all_orders as (
        ...
        from
          ...
          left join "airup_eu_dwh"."shopify_global"."seed_shopify_product_categorisation" product_categorisation
    ...
    all_orders_enriched as (
		select
		   ...
		   case 
				...
				when opt_to_email = NULL then 'Unknown' 
		 	end as opt_to_email
		from
		    all_orders
