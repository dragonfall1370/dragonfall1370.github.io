  ...
  create view "airup_eu_dwh"."shopify_global"."fct_retention_rate_by_product__dbt_tmp" as (
    --legacy: migrated by tomas k.
--legacy: mapping table replaced by tomas kj.
...
WITH all_orders_per_customer AS (
    SELECT DISTINCT foe.customer_id,
                    foe.order_number,
                    foe.created_at,
                    mapping.subcategory_3 pod_flavour,
                    CASE ,
                    CASE
    ...
    FROM "airup_eu_dwh"."shopify_global"."fct_order_enriched" foe
             ...
             left outer join "airup_eu_dwh"."shopify_global"."seed_shopify_product_categorisation" mapping
