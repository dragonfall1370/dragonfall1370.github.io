  ...
  create view "airup_eu_dwh"."shopify_global"."fct_separate_initial_purchase_new__dbt_tmp" as (
    --legacy:  shopify_global.shopify_cohort_processing_separate_initial_purchase_new
...
SELECT  country_abbreviation,
   ...
   FROM 
       "airup_eu_dwh"."shopify_global"."fct_separate_initial_purchase_by_country"
...
UNION ALL
 ...
 SELECT 'all'::character varying AS country_abbreviation,
        ...
        subsequent_orders_with_pods_or_loops_pods_first
   FROM 
      "airup_eu_dwh"."shopify_global"."fct_separate_initial_purchase_global"
