  ...
  create view "airup_eu_dwh"."shopify_global"."fct_order_line_w_created_at__dbt_tmp" as (
    ---Authors: YuShih Hsieh
---Last Modified by: Long Vu

---###################################################################################################################
        -- add created_at column to fct_order_line, report will be shown more correctly
---###################################################################################################################
...
from "airup_eu_dwh"."shopify_global"."fct_order_line" fol 
