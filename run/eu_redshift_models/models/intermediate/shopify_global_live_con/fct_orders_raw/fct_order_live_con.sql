  ...
  create  table
    "airup_eu_dwh"."shopify_global_live_con"."fct_order_live_con__dbt_tmp"
...
SELECT 
  ...
  where date(created_at) >= (select max(three_month_ago) from "airup_eu_dwh"."shopify_global_live_con"."fct_months_back_condition")
