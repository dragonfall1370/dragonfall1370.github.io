...
WITH product_variant_raw AS (
         SELECT product_variant._fivetran_synced,
            ...
            FROM "airup_eu_dwh"."shopify_it"."product_variant"
    ...
    ---enriched product variant and exchange rate information
         ...
         SELECT product_variant_raw._fivetran_synced,
 ...
 SELECT *
   FROM product_variant_enriched

      -----incremental table macro---
    
   where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."product_variant_it")
