...
WITH order_raw AS (
         SELECT id,
            ...
            source_url,
            subtotal_price,
            subtotal_price AS subtotal_price_sek,
           ...
           FROM "airup_eu_dwh"."shopify_se"."order"
        ), 
 ...
 SELECT id,
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_se")
