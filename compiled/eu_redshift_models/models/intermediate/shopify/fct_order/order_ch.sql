...
WITH ch_order_raw AS (
         SELECT id,
            ...
            source_url,
            subtotal_price,
            subtotal_price AS subtotal_price_chf,
           ...
           FROM "airup_eu_dwh"."shopify_ch"."order"
        ), 
 ...
 SELECT id,
   ...
   FROM ch_order_enriched
   
   -----incrememntal table macro---
  
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_ch")
