...
WITH order_raw AS (
         SELECT id,
            ...
            landing_site_ref,
            location_id,
            "substring"(name::text, 2) AS order_number,
            note,
            note_attributes,
            number,
            ...
            subtotal_price AS subtotal_price_gbp,
            subtotal_price_set,
            taxes_included,
            test,
            token,
            ...
            total_tip_received AS total_tip_received_gbp,
            total_weight,
            updated_at,
            user_id,
            'UK'::text AS shopify_shop,
            'GBP'::text AS currency_abbreviation
           FROM "airup_eu_dwh"."shopify_uk"."order"
        ), 
 ...
 SELECT id,
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_uk")
