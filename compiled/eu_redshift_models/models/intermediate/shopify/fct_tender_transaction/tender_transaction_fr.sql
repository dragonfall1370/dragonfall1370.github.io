...
WITH tender_transaction_raw AS (
         SELECT 
            ...
            FROM "airup_eu_dwh"."shopify_fr"."tender_transaction"
 ...
 SELECT
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."tender_transaction_fr")
