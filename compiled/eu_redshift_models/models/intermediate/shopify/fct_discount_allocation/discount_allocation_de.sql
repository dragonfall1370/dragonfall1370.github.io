   ...
   FROM "airup_eu_dwh"."shopify_de"."discount_allocation"
 ...
 -----incrememntal table macro---
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."discount_allocation_de")
