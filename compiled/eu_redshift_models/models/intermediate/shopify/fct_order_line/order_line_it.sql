...
WITH order_line_raw AS (
		 ...
		 SELECT 
           ...
           FROM "airup_eu_dwh"."shopify_it"."order_line"
 ...
 SELECT *
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_line_it")
