   ...
   FROM "airup_eu_dwh"."shopify_de"."order_shipping_line"
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_shipping_line_de")
