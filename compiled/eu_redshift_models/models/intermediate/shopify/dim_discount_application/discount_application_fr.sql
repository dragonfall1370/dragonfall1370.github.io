  ...
  with final as(
   ...
   FROM "airup_eu_dwh"."shopify_fr"."discount_application"
...
-----incremental table macro---
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."discount_application_fr")
