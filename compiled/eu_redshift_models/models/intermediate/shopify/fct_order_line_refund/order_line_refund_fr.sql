...
with 
 ...
 select
   ...
   FROM "airup_eu_dwh"."shopify_fr"."order_line_refund"
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_line_refund_fr")
