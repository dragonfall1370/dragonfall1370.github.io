...
with 
 ...
 select
   ...
   FROM "airup_eu_dwh"."shopify_nl"."order_line_refund"
 ...
 -----incrememntal table macro---
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_global"."order_line_refund_nl")
