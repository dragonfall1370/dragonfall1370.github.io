...
WITH order_raw AS (
         SELECT id,
            _fivetran_synced, 
            date(_fivetran_synced) AS creation_date,
            app_id,
           ...
           FROM "airup_eu_dwh"."shopify_marketplace"."order"
        ), 
 ...
 SELECT id,
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_marketplace"."fct_order_marketplace")
