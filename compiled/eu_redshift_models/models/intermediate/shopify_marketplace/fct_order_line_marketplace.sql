 ...
 select
   ...
   'EUR'::text as currency_abbreviation
    ...
    FROM "airup_eu_dwh"."shopify_marketplace"."order_line"
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_marketplace"."fct_order_line_marketplace")
