...
with 
 ...
 select
   ...
   FROM "airup_eu_dwh"."shopify_marketplace"."order_line_refund"
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_marketplace"."fct_order_line_refund_marketplace")
