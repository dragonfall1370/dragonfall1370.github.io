 ...
 with 
   ...
   FROM "airup_eu_dwh"."shopify_marketplace"."tax_line"
  ...
  where _fivetran_synced >= (select max(_fivetran_synced) from "airup_eu_dwh"."shopify_marketplace"."fct_tax_line_marketplace")
