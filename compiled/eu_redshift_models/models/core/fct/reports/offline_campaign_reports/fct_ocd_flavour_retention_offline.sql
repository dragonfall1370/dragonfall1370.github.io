...
all_orders_per_customer AS (
    SELECT order_enriched.customer_id,
		   ...
		   max(CASE WHEN campaign_purchase IS TRUE THEN 1 ELSE 0 END) OVER (PARTITION BY order_enriched.customer_id)                           AS campaign_customer
    ...
    from "airup_eu_dwh"."shopify_global"."fct_order_enriched" order_enriched
            ...
            LEFT JOIN "airup_eu_dwh"."shopify_global"."seed_shopify_mapping_table_current_and_old_products" seed_flavours
