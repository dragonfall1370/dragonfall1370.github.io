...
WITH all_orders AS (
        ...
        SELECT * FROM (
         ...
         SELECT all_orders.customer_id,
          ...
          GROUP BY all_orders.customer_id, all_orders.country, all_orders.order_id, all_orders.order_value, all_orders.order_date, initial_orders.order_date, all_orders.net_revenue_2
         ...
         SELECT new_returning_customers.country,
            ...
            sum(new_returning_customers.net_revenue_2) AS total_net_revenue_2,
        ...
        SELECT * FROM (
         ...
         SELECT amazon_new_returning_customers.country,
            ...
            0::double precision AS total_net_revenue_2,
 ...
 SELECT agg_customer_order_value.country,
    ...
    agg_customer_order_value.total_net_revenue_2
...
UNION ALL
 SELECT agg_amazon_customers.country,
    ...
    agg_amazon_customers.total_net_revenue_2
...
UNION ALL
 SELECT agg_offline_retail_customers.country,
    ...
    agg_offline_retail_customers.total_net_revenue_2
