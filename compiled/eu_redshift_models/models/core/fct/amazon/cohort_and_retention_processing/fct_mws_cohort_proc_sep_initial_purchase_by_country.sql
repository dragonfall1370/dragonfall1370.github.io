----legacy: amazon.mws_cohort_processing_separate_initial_purchase_by_country
---Authors: Etoma Egot

---###################################################################################################################

        ---compute amazon.mws_cohort_processing_separate_initial_purchase_by_country---
       -- Same logic and view as mws_cohort_processing and shopify's version however, to have a seperate initial purchase
