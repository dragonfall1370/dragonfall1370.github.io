----legacy: amazon.mws_cohort_processing_global
---Authors: Etoma Egot
---Last Modified by: Tomas Kristof

---###################################################################################################################

        ---compute mws_cohort_processing_global---
...
-- 2021-04-23 replaced table name "orders_fullfilled_shipments_manual_upload" with "orders_fulfilled_shipments_manual_upload_enriched"
