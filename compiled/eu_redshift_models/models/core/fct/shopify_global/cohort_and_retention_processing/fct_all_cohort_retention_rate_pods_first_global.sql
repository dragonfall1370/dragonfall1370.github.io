...
with
	...
	main_groupby as
		...
		from
			data_prep_2
		WHERE data_prep_2.cohort >= '2020-04-01'::date
			   AND (data_prep_2.nth_order = 2 OR data_prep_2.nth_order = 1 AND
															 data_prep_2.pods::double precision >= 1::double precision)
		group by
			cohort,
